  ...
  <div class="mt-2">
    ...
    >
      ...
      <el-form-item prop="mobile">
        <el-input v-model="goodsQueryParams.mobile" placeholder="选择供应商"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="handleQueryGoods">查询</el-button>
        <el-button type="primary" @click="handleOpenDialog">新增</el-button>
        <el-button @click="handleReset('goodsQueryParams')">重置</el-button>
      </el-form-item>
    </el-form>
    <!-- 表格 -->
    <el-table :data="goodsList" height="380" border="" style="width: 100%">
      ...
      <el-table-column prop="商品编码" label="code" width="110"></el-table-column>
      ...
      <el-table-column label="操作" width="150">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="danger" @click="handleDeletesupplier(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" width="500px">
      <el-form :model="dialogForm" style="width: 300px" ref="dialogForm" :rules="dialogFormrules">
